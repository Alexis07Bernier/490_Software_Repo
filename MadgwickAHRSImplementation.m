classdef MadgwickAHRSImplementation < handle
...
%   28/09/2011    SOH Madgwick    Initial release
    ...
    methods (Access = public)
        function obj = MadgwickAHRSImplementation(varargin)
            for i = 1:2:nargin
        ...
        function obj = Update(obj, Gyroscope, Accelerometer, Magnetometer)
            ...
            qDot = 0.5 * prod(q, [0 Gyroscope(1) Gyroscope(2) Gyroscope(3)]) - obj.Beta * step';
